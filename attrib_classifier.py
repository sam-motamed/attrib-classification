...
def parse(args=None):
    ...
    parser.add_argument('--attr_path', dest='attr_path', type=str, default='./ff-celeb.txt')
...
for e in tqdm(range(1, EPOCHS+1)):
    with tqdm(train_loader, unit="batch") as tepoch:
        ...
        for X_train_batch, y_train_batch in tepoch:
            ...
            train_loss = BCELoss_IGNORE(y_train_pred, y_train_batch, 5)
            train_loss.backward()
            optimizer.step()
